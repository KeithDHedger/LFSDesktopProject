...
//edit
enum {UNDOMENUITEM=0x9000,REDOMENUITEM,UNDOALLMENUITEM,REDOALLMENUITEM,CUTMENUITEM,COPYMENUITEM,PASTEMENUITEM,FINDMENUITEM,FINDNEXTMENUITEM,SORTTABSMENUITEM,SHOWALLTABSMENUITEM,SELECTTABMENUITEM,PREFSMENUITEM,PLUGPREFSMENUITEM};
//view
...
enum {GOBACKMENUITEM=0xb000,GOFORWARDMENUITEM,GOTODEFINEMENUITEM,OPENINCLUDEMENUITEM,GOTOLINEMENUITEM};
