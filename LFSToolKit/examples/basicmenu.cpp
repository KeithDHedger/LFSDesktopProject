...
g++ "$0" -O0 -ggdb -I../LFSToolKit -L../LFSToolKit/app/.libs $(pkg-config --cflags --libs x11 xft cairo ) -llfstoolkit -lImlib2 -o menuexample||exit 1
LD_LIBRARY_PATH=../LFSToolKit/app/.libs ./menuexample "$@"
retval=$?
