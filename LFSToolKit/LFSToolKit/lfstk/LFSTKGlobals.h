...
enum contextPostition {CONTEXTLEFT,CONTEXTRIGHT,CONTEXTCENTRE,CONTEXTATMOUSE,CONTEXTABOVELEFT,CONTEXTABOVECENTRE,CONTEXTABOVERIGHT,CONTEXTNORTH,CONTEXTNORTHEAST,CONTEXTEAST,CONTEXTSOUTHEAST,CONTEXTSOUTH,CONTEXTSOUTHWEST,CONTEXTWEST,CONTEXTNORTHWEST};
//dropdata
