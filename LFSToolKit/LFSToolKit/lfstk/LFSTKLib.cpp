...
void LFSTK_lib::LFSTK_reloadPrefs(void)
{
	...
	this->prefs.prefsMap=
		{
			{this->prefs.LFSTK_hashFromKey("window_normal"),{TYPESTRING,"window_normal","grey40",false,0}},
			{this->prefs.LFSTK_hashFromKey("window_prelight"),{TYPESTRING,"window_prelight","grey40",false,0}},
			{this->prefs.LFSTK_hashFromKey("window_active"),{TYPESTRING,"window_active",",grey40",false,0}},
			{this->prefs.LFSTK_hashFromKey("window_inactive"),{TYPESTRING,"window_inactive","grey40",false,0}},
			{this->prefs.LFSTK_hashFromKey("windowtile"),{TYPESTRING,"windowtile","",false,0}},

			{this->prefs.LFSTK_hashFromKey("button_normal"),{TYPESTRING,"button_normal","#A3A3A3",false,0}},
			{this->prefs.LFSTK_hashFromKey("button_prelight"),{TYPESTRING,"button_prelight","#7B7B7B",false,0}},
			{this->prefs.LFSTK_hashFromKey("button_active"),{TYPESTRING,"button_active","#676767",false,0}},
			{this->prefs.LFSTK_hashFromKey("button_inactive"),{TYPESTRING,"button_inactive","#D1D1D1",false,0}},
			{this->prefs.LFSTK_hashFromKey("buttontile"),{TYPESTRING,"buttontile","",false,0}},

			{this->prefs.LFSTK_hashFromKey("menuitem_normal"),{TYPESTRING,"menuitem_normal","#979797",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_prelight"),{TYPESTRING,"menuitem_prelight","#979797",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_active"),{TYPESTRING,"menuitem_active","#676767",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_inactive"),{TYPESTRING,"menuitem_inactive","#d1d1d1",false,0}},

			{this->prefs.LFSTK_hashFromKey("menuitem_font"),{TYPESTRING,"menuitem_font","sans:size=10",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_font_normal"),{TYPESTRING,"menuitem_font_normal","black",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_font_prelight"),{TYPESTRING,"menuitem_font_prelight","grey20",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_font_active"),{TYPESTRING,"menuitem_font_active","black",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitem_font_inactive"),{TYPESTRING,"menuitem_font_inactive","grey",false,0}},
			{this->prefs.LFSTK_hashFromKey("menuitemtile"),{TYPESTRING,"menuitemtile","",false,0}},

			{this->prefs.LFSTK_hashFromKey("font"),{TYPESTRING,"font","sans:size=10",false,0}},
			{this->prefs.LFSTK_hashFromKey("font_normal"),{TYPESTRING,"font_normal","white",false,0}},
			{this->prefs.LFSTK_hashFromKey("font_prelight"),{TYPESTRING,"font_prelight","grey20",false,0}},
			{this->prefs.LFSTK_hashFromKey("font_active"),{TYPESTRING,"font_active","black",false,0}},
			{this->prefs.LFSTK_hashFromKey("font_inactive"),{TYPESTRING,"font_inactive","grey",false,0}},
			...
			{this->prefs.LFSTK_hashFromKey("monofont"),{TYPESTRING,"monofont","mono:size=12",false,0}},
			{this->prefs.LFSTK_hashFromKey("cursorcolour"),{TYPESTRING,"cursorcolour","grey80",false,0}},
			{this->prefs.LFSTK_hashFromKey("sbtroughcolour"),{TYPESTRING,"sbtroughcolour","grey80",false,0}},
			{this->prefs.LFSTK_hashFromKey("listtroughcolour"),{TYPESTRING,"listtroughcolour","grey60",false,0}}
		};
